...
function initialize(start_Date_init, end_Date_init) {
    ...
    request.onreadystatechange = () => {
        ...
        //get dates
        for (var j = 0; j < queue_lengths_single.enquiries.length; j++) {

            dates[j] = queue_lengths_single.enquiries[j].date;
        ...
        for (var j = 0; j < count; j++) {
            ...
            service_queue_lengths[keys[j]] = new Array();
        ...
        for (var i = 0; i < count; i++) {
            ...
            for (var j = 0; j < array1.length; j++) {
                ...
                service_queue_lengths[keys[i]].push(array1[j].length);
        ...
        Highcharts.chart('queue_lengths_Single', {
            ...
            title: {
                text: 'Comparative queue lengths for each service'
            },
            subtitle: {
                text: 'Source: Qliner'
            },
            ...
            series: [{
                name: 'Enquiries',
                data: service_queue_lengths[keys[0]]

            }, {
                name: 'consultation',
                data: service_queue_lengths[keys[1]]
            }, {
                name: 'paediatrics',
                data: service_queue_lengths[keys[2]]

            }, {
                name: 'pharmacy',
                data: service_queue_lengths[keys[3]]

            },
            {
                name: 'accidents_emergencies',
                data: service_queue_lengths[keys[4]]
            },
            {
                name: 'laboratory',
                data: service_queue_lengths[keys[5]]
